  ...
  return (
    <>
      <div className="header-top">
        <div className="bg-[#243576] sm:flex justify-center font-graphik text-white text-center sm:px-3 text-[10px] lg:text-[13px] font-bold py-[15px] tracking-[0.25px]">
          <span>
            Payday Surprise: ลด 20% ไม่มีขั้นต | หรือ ลด 25% จาก UOB ในเวลาจำกัด
          </span>
          <span className=" font-graphik font-bold text[11px]">
            01 DAY : 21 HRS : 39 MINS : 06 SECS
          </span>
        </div>
      </div>
      <header>
        <nav className="bg-white border-gray-200 px-4 lg:px-11 py-2.5 dark:bg-gray-800 overflow-hidden">
          <div className="grid grid-cols-3">
          <div
              className= {` top-[150px] ${isNavbarDisplayed ? 'navbar_display' : ''} hidden justify-start items-center w-full lg:flex lg:w-auto`}
              id="mobile-menu-2"
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  <a
                    href="#"
                    className="block py-2 pr-4 pl-3 text-[#000000] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 font-sukhumvit font-semibold"
                    aria-current="page"
                  >
                    สินค้าใหม
                  </a>
            ...
            <a
              href="#"
              className="flex items-center lg:justify-center  sm:col-start-1 sm:col-end-3 lg:col-start-2 lg:col-end-3"
            >
              <img
                src="clinton-logo.png"
                className="  w-[200px] lg:h-auto"
                alt="Flowbite Logo"
              />
            </a>
            ...
            <div className="flex items-center justify-end     col-start-3">
              <a
                href="#"
                className="lg:flex space-x-4 hidden text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
              >
                <p className="block py-2 pr-4 pl-3 text-[#000000] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 font-sukhumvit font-semibold">
                  ลงทะเบียน
                </p>
                <p className="block py-2 pr-4 pl-3 text-[#000000] border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 font-sukhumvit font-semibold">
                  เข้าสู่ระบบ
                ...
                <p>|</p>
                <img src="th-flag.svg.png" alt="" />
                <img src="search.svg.png" alt="" />
                <img src="bag.svg.png" alt="" />
              </a>
              <button
